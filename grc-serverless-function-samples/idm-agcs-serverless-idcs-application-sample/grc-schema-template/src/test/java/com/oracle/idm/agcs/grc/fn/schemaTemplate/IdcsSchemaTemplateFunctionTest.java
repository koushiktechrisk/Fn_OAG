...
public class IdcsSchemaTemplateFunctionTest extends SchemaTemplateFunctionTest {
  ...
  public void shouldReturnFiveEntityInSchemaTemplateForIdcsConnectedSystem()
    ...
    SchemaTemplateInput input =
        SchemaTemplateInput.builder().connectedSystemName(idcsConnectedSystemName).build();
